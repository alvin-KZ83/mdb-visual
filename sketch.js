...
let layerSpacing = 15; // Spacing between layers
...
function setup() {
  ...
  // # of points (polygon)
  slider2 = createSliderWithStyle(3, 360, 360, 1, (width - sliderWidth) / 2, height - 150, sliderWidth + 'px');
  ...
  // Thickness
  slider5 = createSliderWithStyle(1, 5, 1, 0.01, (width - sliderWidth) / 2, height - 300, sliderWidth + 'px');
  createLabelWithStyle('Thickness', (width - sliderWidth) / 2, height - 300, sliderWidth + 'px');

  // Spacing
  slider6 = createSliderWithStyle(10, 50, 15, 1, (width - sliderWidth) / 2, height - 350, sliderWidth + 'px');
  createLabelWithStyle('Spacing', (width - sliderWidth) / 2, height - 350, sliderWidth + 'px');
}
